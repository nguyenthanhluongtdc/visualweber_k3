...
var countDownDate = new Date("Sep 24, 2021 18:00:00").getTime();
...
var x = setInterval(function() {
  ...
  document.getElementById("days") ? document.getElementById("days").innerHTML = days.toString().padStart(2,0) : '00';
  document.getElementById("hours") ? document.getElementById("hours").innerHTML = hours.toString().padStart(2,0) : '00';
  document.getElementById("minutes") ? document.getElementById("minutes").innerHTML = minutes.toString().padStart(2,0) : '00';
  document.getElementById("seconds") ? document.getElementById("seconds").innerHTML = seconds.toString().padStart(2,0) : '00';
