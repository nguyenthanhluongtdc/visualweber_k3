<div class="section section11 fp-auto-height-responsive fp-section fp-completely" data-anchor="chon-xe-online">
    ...
    <div class="section11-wrap container-remake">
        <h3 class="font80 font-buenos-bold" data-aos="fade-down" data-aos-offset="300" data-aos-duration="700" data-aos-easing="ease-in-sine">Chọn xe trực tuyến</h3>
        <div class="start" data-aos="flip-down" data-aos-offset="300" data-aos-duration="700" data-aos-easing="ease-in-sine">
            <a href="">
                <div class="img"><img src="{{ Theme::asset()->url('images/section11/s11icon.png') }}"></div>
                <p class="font20 font-buenos-re">Bắt đầu ngay</p>
            </a>
        </div>
        <div class="car-s11" data-aos="fade-left" data-aos-offset="300" data-aos-duration="500" data-aos-easing="ease-in-sine">
            <img src="{{ Theme::asset()->url('images/section11/s11car.png') }}">
        </div>
        <div class="action-s11">
            <div class="action-item" data-aos="flip-up" data-aos-offset="300" data-aos-duration="700" data-aos-easing="ease-in-sine">
                <a href="">
            ...
            <div class="action-item" data-aos="flip-up" data-aos-offset="300" data-aos-duration="700" data-aos-easing="ease-in-sine" data-aos-delay="900">
                <a href="">
