                ...
                <div class="bottom">
                                    ...
                                    <div class="left">
                                        ...
                                        <div class="chose-car-color">
                                              ...
                                              <div class="tab-content tab-content-color2">
                                                ...
                                                <div id="color4" class="container tab-pane item-car-color "><br>
                                                    <img src="{{ Theme::asset()->url('images/form/whitepri.png') }}"
                                                    alt="">
                                                </div>
                                                <div id="color5" class="container tab-pane item-car-color "><br>
                                                    <img src="{{ Theme::asset()->url('images/form/whitepri.png') }}"
                                                    alt="">
                                                </div>
                                                <div id="color6" class="container tab-pane item-car-color "><br>
                                                    <img src="{{ Theme::asset()->url('images/form/whitepri.png') }}"
                                                    alt="">
                                                </div>
                                                <div id="color7" class="container tab-pane item-car-color "><br>
                                                    <img src="{{ Theme::asset()->url('images/form/whitepri.png') }}"
                                                    alt="">
                                                </div>
                                            </div>
                                            <ul class="nav nav-tabs tab-color-car2" role="tablist">
                                                {{-- Blue 1 --}}
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab" href="#color1">
                                                ...
                                                {{-- White --}}
                                                <li class="nav-item">
                                                    <a class="nav-link " data-toggle="tab" href="#color2">
                                                ...
                                                {{-- Black --}}
                                                <li class="nav-item">
                                                    <a class="nav-link " data-toggle="tab" href="#color3">
                    ...
                    <div class="content-bottom none-pcc">
                        <a class="register font-kia-bold font20 font-kia-re" data-src="#animatedModal102"
                            href="javascript:;" data-fancybox="muaxe1b"
                            class="">
                                BẮT ĐẦU NGAY
                            </a>
                            <div style="
    ...
    <div class="item" data-aos="fade-up" data-aos-offset="300" data-aos-duration="500"
        ...
        <div class="bottom">
            ...
            <div class="content-item">
                ...
                <div class="content-bottom none-mobiee">
                    <a class="register font-kia-bold font20 font-kia-re" data-src="#animatedModal101"
                        href="javascript:;" data-fancybox="muaxe3"
                        class="">
                                BẮT ĐẦU NGAY
                            </a>
            ...
            <div class="content-bottom none-pcc">
                <a class="register font-kia-bold font20 font-kia-re" data-src="#animatedModal102" href="javascript:;"
                    data-fancybox="muaxe3b"
                    class="">
                                BẮT ĐẦU NGAY
                            </a>
                            <div style="
...
<div class="item" data-aos="fade-up" data-aos-offset="300" data-aos-duration="500"
    ...
    <div class="bottom">
        ...
        <div class="content-item">
            ...
            <div class="content-bottom none-mobiee">
                <a class="register font-kia-bold font20 font-kia-re" data-src="#animatedModal101" href="javascript:;"
                    data-fancybox="muaxe2"
                    class="">
                                BẮT ĐẦU NGAY
                            </a>
