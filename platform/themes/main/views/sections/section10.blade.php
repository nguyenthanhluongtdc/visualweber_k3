                            ...
                            <div style="
                                ...
                                <div class="form-buy-car">
                                    ...
                                    <div class="right"
                                        ...
                                        @includeIf('theme.main::views.templates.form',['car_type'=>'1.6
                                        Premium','modal'=>'animatedModal101'])
                                    </div>
                                </div>
                            </div>
                            ...
                            <div style="
                                ...
                                <div class="form-buy-car">
                                    ...
                                    <div class="right"
                                        ...
                                        <h2
                                            class="form__title text-center font50 text-uppercase text-white font-buenos-bold">
                                            ĐẶT XE TRỰC TUYẾN</h2>
                                        <div class="form__body">
                                            <p class="form__input">
                                                <label for="city" class="font16">Tỉnh thành (*): </label>
                                                <select name="city" id="city_buy_car"
                                                    class="font-buenos-light ui search selection dropdown city w-100"
                                                    required>
                                                    <option hidden value="" selected>Vui lòng chọn tỉnh thành
                                                    </option>
                                            ...
                                            <p class="form__input">
                                                ...
                                                <select name="showroom"
                                                    class="font-buenos-light ui search selection dropdown showroom w-100 showroom-book-a-car"
                                                    required>
                                            ...
                                            <div class="form__total-cost text-center">
                                                ...
                                                <p class="font-buenos-light font-mobie-small">
                                                    (Tổng chi phí ước tính mang tính chất tham khảo. Vui lòng liên hệ
                                                    Showroom để biết thêm chi tiết.)
                                                </p>
                                            </div>

                                            <p class="form__input">
                                                <label for="" class="font16 font-buenos-light">Thời gian nhận xe (*):
                                                </label>
                                                <input name="date" type="date"
                                                    class="date ui search selection dropdown">
                                            </p>

                                            <p class="form__input">
                                                <label for="date" class="font16 font-buenos-light"> Khách hàng (*):
                                                </label>
                                                <input name="customer_name" class="ui search selection dropdown"
                                                    type="text" placeholder="Họ và tên">
                                            </p>

                                            <p class="form__input">
                                                <label for="date" class="font16 font-buenos-light">Số điện thoại (*):
                                                </label>
                                                <input name="customer_phone" class="ui search selection dropdown"
                                                    type="text" placeholder="Nhập số điện thoại">
                                            </p>

                                            <p class="form__input">
                                                <label for="date" class="font16 font-buenos-light">Địa chỉ liên hệ
                                                    (*):</label>
                                                <input name="customer_address" class="ui search selection dropdown"
                                                    type="text" placeholder="Nhập địa chỉ liên hệ">
                                            </p>

                                            <div class="form__position">
                                                <div class="item-right">
                                                    <select id="customer__city" name="customer__city"
                                                        class="font-buenos-light ui search selection dropdown customner__city"
                                                        required>
                                                        <option value="" selected>Tỉnh/ Thành phố</option>
                                                        @forelse(@$provinces as $row)
                                                            <option
                                                                {{ old('city') == @$row->matp ? 'selected' : '' }}
                                                                value="{{ @$row->matp }}">{{ @$row->name }}
                                                            </option>
                                                        @empty
                                                        @endforelse
                                                    </select>

                                                    <select id="customer__district" name="customer__district"
                                                        class="font-buenos-light ui search selection dropdown customer__district"
                                                        required>
                                                        <option value="" selected>Quận/ Huyện</option>
                                                    </select>

                                                    <select id="customer__ward" name="customer__ward"
                                                        class="font-buenos-light ui search selection dropdown customer__ward"
                                                        required>
                                            ...
                                            <p class="form__input">
                                                ...
                                                <input name="customer_email" class="ui search selection dropdown"
                                                    type="text" placeholder="Nhập thông tin email">
                                            </p>

                                            <p class="form__checkbox">
                                                <input type="checkbox" name="accept" id="accept">
                                                <label class="ml-3 mb-0 font16 font-buenos-light" for="accept">Đồng ý
                                                    nhận thông tin từ KIA</label>
                                            </p>
                        ...
                        <a class="register font-kia-bold font20 font-kia-re" id="pre-order-car"
                            ...
                            <div class="form-buy-car">
                                ...
                                <div class="right"
                                    style="background-image: url({{ Theme::asset()->url('images/form/bgform.jpg') }}); background-size: cover; background-repeat: no-repeat;">
                                    {!! Form::open(['route' => 'public.send.contact-buy-cars', 'method' => 'POST', 'class' => 'form form-car text-white', 'id' => 'id="book-a-car"']) !!}
                                    <form id="book-a-car" action="{{ route('public.send.contact-buy-cars') }}"
                                        method="POST" class="form text-white">
                                        <h2
                                            class="form__title text-center font50 text-uppercase text-white font-buenos-bold">
                                            ĐẶT XE TRỰC TUYẾN</h2>
                                        <div class="form__body">
