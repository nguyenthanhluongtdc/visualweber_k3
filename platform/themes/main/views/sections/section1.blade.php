<div data-anchor="trang-chu" class="section section1 fp-auto-height-responsive fp-section fp-completely active" 
    ...
    <div class="s1-mobie">
       <div class="img-pri-s1">
        {{-- <div class="bg-image" style="background-image: url({{ Theme::asset()->url('images/section1/hinhmb1.jpg') }}); background-repeat: no-repeat; background-size: cover;">
        ...
        <div class="box-bottom">
            ...
            <div class="bottom" style="background-image: url('{{ Theme::asset()->url('images/section1/bgmb.jpg') }}')">
                ...
                {{-- data-aos-duration="1000" data-aos-easing="ease-in-sine" data-aos-delay="900" --}}
                <div class="item" >
                    <div class="img"><img src="{{ Theme::asset()->url('images/section1/iconcar.png') }}" alt=""></div>
